...
#             self.data[METERS][len(self.data) - 1] = user_input
#         if user_input is None or user_input[ADD_MORE] is True:
#             self.data[METERS].append(self._get_default_entry())
...
#         current = self.data[METERS][len(self.data) - 1]
#         data_schema = vol.Schema(
#             {
#                 vol.Required(
#                     CONF_ENTITY_ID, default=current[CONF_ENTITY_ID]
...
#                 ): cv.positive_int,
#                 vol.Optional(CONF_COUNT, default=current[CONF_COUNT]): cv.positive_int,
#                 vol.Optional(
